...
const ChatLayout = () => {
  ...
  return (
    <div className="h-screen flex bg-black text-orange-400">
      {/* Sidebar - Left side */}
      <aside className="w-full sm:w-1/3 lg:w-1/4 h-full border-r border-orange-600 shadow-md bg-black">
        <Sidebar onConversationSelect={handleConversationSelect} />
      </aside>
      ...
      <main className="flex-1 flex flex-col overflow-hidden bg-black">
        {activeConversation ? (
          ...
          <div className="flex justify-center items-center h-full text-orange-500 text-lg">
            Select a conversation to start chatting
          </div>
        )}
      </main>
